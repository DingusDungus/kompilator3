  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_typeIdentifier = 49,                   // typeIdentifier
        S_typeIdentifiers = 50,                  // typeIdentifiers
        S_typeIdentifierList = 51,               // typeIdentifierList
        S_expressions = 52,                      // expressions
        S_expressionList = 53,                   // expressionList
        S_classDeclaration = 54,                 // classDeclaration
        S_classDeclarationList = 55,             // classDeclarationList
        S_classDeclarations = 56,                // classDeclarations
        S_methodDeclaration = 57,                // methodDeclaration
        S_methodDeclarationList = 58,            // methodDeclarationList
        S_methodDeclarations = 59,               // methodDeclarations
        S_extendsIdentifier = 60,                // extendsIdentifier
        S_varDeclarations = 61,                  // varDeclarations
        S_varDeclaration = 62,                   // varDeclaration
        S_type = 63,                             // type
        S_statements = 64,                       // statements
        S_statementList = 65,                    // statementList
        S_statement = 66,                        // statement
        S_expression = 67,                       // expression
        S_identifier = 68,                       // identifier
        S_end = 69                               // end
      };
    };
